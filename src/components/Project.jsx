...
const Project = ({ project, children }) => {
  ...
  return (
    <a href={project.href || '#'} target="_blank" className="pointer-events-auto">
      <div className={`${variant} min-h-[10rem] md:min-h-[20rem] shadow-lg rounded-md p-2 hover:scale-[102%] hover:shadow-xl cursor-pointer transition-all`}>
        ...
        <p className="text-lg card-desc" dangerouslySetInnerHTML={{__html: project.desc || ''}} />
      </div>
    </a>
  )
};
